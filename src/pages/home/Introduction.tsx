...
const Introduction = () => {
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <h2 className="text-2xl font-semibold mt-6">📜 Contexto Histórico</h2>
      <p className="mt-2">
        Go, también conocido como **Golang**, es un lenguaje de programación creado por 
        **Google** en **2007** y lanzado oficialmente en **2009**. Fue diseñado por 
      ...
      <p className="mt-2">
        Inspirado en lenguajes como **C** y **Python**, Go combina **simplicidad** con **alto rendimiento** 
        y una gestión eficiente de la **concurrencia** mediante **goroutines**. Hoy en día, es ampliamente 
